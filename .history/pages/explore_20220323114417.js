...
export default function Explore() {
  ...
  function setMaxPrice(e) {
    ...
    let Nft = newNftRef.current.filter(i=> ((minPrice || 0) < i.price && i.price < (e.target.value || 1000)));
    setNewNft([...Nft]);
  }
  function setMinPrice(e) {
      setMinPriceOld(e.target.value);
    let Nft = newNftRef.current.filter(i=> ((maxPrice || 1000) > i.price && i.price > (e.target.value || 0)));
    setNewNft([...Nft]);
  }
