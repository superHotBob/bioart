    ...
    <div className="mainBlock">
      ...
      <Form onSubmit={handleSubmit}>
       ...
       <label>
              ...
              <p>
                <input
                 type="radio"  name="picked" value="Genome NFT" onChange={getFieldProps("picked").onChange} />
                <span>
              ...
              <p>
                <input
                 type="radio"  name="picked" value="Geno`s Collection" onChange={getFieldProps("picked").onChange}/>
                <span>
                  <Image src="/icon_ba.svg" width={38} height={38} alt="icon" />
                </span>
                Geno`s Collection
              ...
              <p>
                <input type="radio"  name="picked" value="NYC Underground ..." onChange={getFieldProps("picked").onChange}/>
                <span>
                  <Image src="/icon_ba.svg" width={38} height={38} alt="icon" />
                </span>
                NYC Underground ...
              ...
              <p>
                <input
                 type="radio"  name="picked" value="Genome Story" onChange={getFieldProps("picked").onChange}/>
                <span>
                  <Image src="/icon_ba.svg" width={38} height={38} alt="icon" />
                </span>
                Genome Story
            ...
            <label>
              ...
              <p>
                <input type="checkbox" style={{width: 20,height: 20}} name="checked" onChange={getFieldProps("currState").onChange} value="Item Sold" />{" "}
