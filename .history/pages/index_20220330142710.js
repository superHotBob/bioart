      ...
      <section className={styles.table}>
        ...
        <div className={styles.tableBody}>
          <div className={styles.headerTable}>
            <span className={styles.mobileNo} style={{ textAlign: "left" }}>Ranking</span>
            <span className={styles.mobile} style={{ flexGrow: 4, textAlign: "left" }}>Planet</span>
            <span className={styles.mobileNo}>Volume ▼</span>
