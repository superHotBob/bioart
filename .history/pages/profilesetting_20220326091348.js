...
import { token, name, email } from "../reduser";
import { useState } from "react";

export default function Profile() {
   const myemail = useSelector(email);
   const [ne,fgdfg] = useState('dfgd')
          ...
          <label>
            ...
            <p>
              <input
                ...
                value="Genome NFT"
                onChange={getFieldProps("value").onChange}
              />
              <span>
            ...
            <p>
              <input
                ...
                onChange={getFieldProps("picked").onChange}
              />
              <span>
                <Image src="/icon_ba.svg" width={38} height={38} alt="icon" />
              </span>
          ...
          <label>
            ...
            <p>
              <input
                type="checkbox"
                name="notification"
                onChange={getFieldProps("Item Sold").onChange}
                value="Item Sold"
              />{" "}
            ...
            <p>
              <input 
                type="checkbox"
                name="notification" 
                onChange={getFieldProps("Bid Activity").onChange} 
                value="Bid Activity" 
               />{" "}
            ...
            <p>
              <input 
                type="checkbox"
                onChange={getFieldProps("Price Change").onChange} 
                name="notification" 
                value="Price Change" 
              />{" "}
            ...
            <p>
              <input
                type="checkbox"
                onChange={getFieldProps("Auction Expiration").onChange}
                name="notification"
            ...
            <p>
              <input
                type="checkbox"
                name="notification"
                onChange={getFieldProps("Successful Purchase").onChange}
            ...
            <p>
              <input
                type="checkbox"
                name="notification"
                onChange={getFieldProps("GenoVerse Newsletter").onChange}
