...
import { clusterApiUrl, Connection, PublicKey, Keypair,getBalance } from "@solana/web3.js";
...
export default function CreateItem() {
  ...
  useEffect(() => {
    async function Blob() {
      ...
      let sss = await getBalance({publicKey:"7NDNkxWFHFsFrw93pxv5UC8613pm67E8CoAYmd8mZ3rT"});
      console.log(sss);
