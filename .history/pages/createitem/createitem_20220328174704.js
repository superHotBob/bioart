...
import { clusterApiUrl, Connection, PublicKey, Keypair,getTokenAccountBalance } from "@solana/web3.js";
...
export default function CreateItem() {
  ...
  useEffect(() => {
    async function Blob() {
      let sss = await connection.getTokenAccountBalance("7NDNkxWFHFsFrw93pxv5UC8613pm67E8CoAYmd8mZ3rT");
      console.log(sss);
