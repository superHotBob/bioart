...
import { clusterApiUrl, Connection, PublicKey, Keypair,getAccountInfo } from "@solana/web3.js";
...
export default function CreateItem() {
  ...
  return (
    <div className="mainCreateItemBlock">
      <h1 className="mobileYes">Create New Item</h1>
      <p className="itemName requared mobileYes"> requared input</p>
      ...
      <div className="contentBlock">
        <h1 className="mobileNo">Create New Item</h1>
        <p className="itemName requared mobileNo"> requared input</p>
        <label>
