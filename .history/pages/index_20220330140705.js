      ...
      <section className={styles.table}>
        ...
        <div className={styles.tableBody}>
          <div className={styles.headerTable}>
            <span className="modile" style={{ textAlign: "left" }}>Ranking</span>
            <span style={{ flexGrow: 4, textAlign: "left" }}>Planet</span>
            <span className="modile">Volume ▼</span>
            <span className="modile">24h%</span>
            <span className="modile">7d%</span>
            <span className="modile">Floor price</span>
            <span className="modile">Owners</span>
            <span className="modile">Items</span>
          </div>
