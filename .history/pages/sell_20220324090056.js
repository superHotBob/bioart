    ...
    <div className="sellMainBlock">
      ...
      <div className="content">
        ...
        <div className="blockRadios">
          ...
          <div className="starting">
              <span>Ending</span>
              <select style={{width: '25%'}}></select><Image src='/icon_drp_arr.svg' className="triangle" width={20} height={20} alt='icon' />
              <select></select>
              <select></select>
              <b>:</b>
              <select></select>
        ...
        <div className="creatorFree">
          Creator Free<b>10.0%</b><button className="question">?</button><b className="answer">dsfsdfsdf</b>
        </div>
