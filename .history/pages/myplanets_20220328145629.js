      ...
      <div className="items">
        <div className="genomeStore">
            <div className="genomeStore__text"> 
                ...
                <p className="icons">
                    <figure>
                        <Image src='/icon_tele.png' width={20} height={20} alt='icon' />
                    </figure>
                    <figure>
                        <Image src='/' width={20} height={20} alt='icon' />
                    </figure>
                    <figure>
                        <Image src='/icon_facebook.png' width={20} height={20} alt='icon' />
                    </figure>
                    <figure>
                        <Image src='/icon_twitter_b.png' width={20} height={20} alt='icon' />
                    </figure>
                    <a>bioart.net</a>
