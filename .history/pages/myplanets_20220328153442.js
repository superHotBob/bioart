...
export default function Explore() {
  ...
  return (<>
    <div className="mainExplore">
      ...
      <div className="items">
        <div className="genomeStore">
            <div className="genomeStore__text"> 
                <h2>Gemone Story</h2>
                <p className="icons">
                    <figure>
                        <Image src='/icon_tele.png' width={27} height={27} alt='icon' />
                    </figure>
                    <figure>
                        <Image src='/icon_insta_b.png' width={27} height={27} alt='icon' />
                    </figure>
                    <figure>
                        <Image src='/icon_facebook.png' width={27} height={27} alt='icon' />
                    </figure>
                    <figure>
                        <Image src='/icon_twitter_b.png' width={27} height={27} alt='icon' />
                    </figure>
                    <a href="/" >bioart.net</a>
                ...
                <div className="counters">
                    <span>Item <b>8</b></span>
                    <span>Owner <b>305</b></span>
                    <span>Floor price 
                        <figure>
                            <Image src='/icon_graph_01.svg' width={20} height={20} alt='icon' />
                        </figure> <b>---</b></span>
                    <span>Valume traded <b>1</b></span>
                </div>
            </div>
        </div>  
