    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <div className={styles.header}>
          ...
          <a className={styles.tab01}><img src="/icon_tab_on_01.svg" width={40} height={40} /></a>
          <a className={styles.tab02}><img src="/icon_tab_off_02.svg" width={40} height={40} /></a>
          <a className={styles.tab03}><img src="/icon_tab_off_03.svg" width={40} height={40} /></a>
