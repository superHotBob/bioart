...
export default function Profile() {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      representaive_planet: myprofile.representaive_planet,
      notification: [],
    },
    onSubmit: (values) => {
          ...
          <label>
            ...
            <p>
              <input
                ...
                value="Genome NFT"
                checked={myprofile.representaive_planet === "Genome NFT"}
            ...
            <p>
              <input
                ...
                checked={myprofile.representaive_planet === "Geno`s Collection"}
            ...
            <p>
              <input
                type="radio"
                name="representaive_planet"
                checked={myprofile.representaive_planet === "NYC Underground ..."}
            ...
            <p>
              <input
                type="radio"
                name="representaive_planet"
                checked={myprofile.representaive_planet === "Genome Story"}
                value="Genome Story"
                onChange={formik.getFieldProps("picked").onChange}
              />
              <span>
