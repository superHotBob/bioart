        ...
        {({ values }) => (
          <Form>
            ...
            <label>
              ...
              <p>
                <Field type="checkbox" name="checked" value="Item Sold" />{" "}
                <b>Item Sold</b> When someone purchased one of your items
              </p>
              <p>
                <Field type="checkbox" name="checked" value="Bid Activity" />{" "}
                <b>Bid Activity</b> When someone bids on one of your items
              </p>
              <p>
                <Field type="checkbox" name="checked" value="Price Change" />{" "}
