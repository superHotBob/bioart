        ...
        <Form onSubmit={formik.handleSubmit}>
          ...
          <label>
            ...
            <input
              ...
              onChange={formik.getFieldProps("name").onChange}
            />
            {formik.errors.email && touched.email ? <div>{formik.errors.email}</div> : null}
          </label>
          <label>
            ...
            <p>
              <input
                ...
                checked={formik.values.representaive_planet === "Geno`s Collection"}
                onChange={formik.getFieldProps("value").onChange}
              />
              <span>
                <Image src="/icon_ba.svg" width={38} height={38} alt="icon" />
            ...
            <p>
              <input
                type="radio"
                name="representaive_planet"
                checked={formik.values.representaive_planet === "NYC Underground ..."}
