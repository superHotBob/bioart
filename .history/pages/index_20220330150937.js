        ...
        <div className={styles.tableBody}>
          ...
          <div className={styles.data}>
            <p className={styles.headerTableFirst}>
              ...
              >
                BioArts <br className="br" /> <span className={styles.mobileYes}> Rankin 1247</span>
              </span>
            ...
            {data.map((i, index) => (
              <p key={index} className={styles.headerTable}>
                <span className={styles.mobile} style={{ textAlign: "left" }}>Ranlin {i.ranking}</span>
                <span
                  style={{
                    flexGrow: 4,
                    height: "50px",
                ...
                >
                  {i.planet} <span className={styles.mobileYes}>{i.ranking}</span>
                </span>
