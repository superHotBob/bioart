          ...
          <label>
            ...
            <p>
              <input
                ...
                checked={profile.representaive_planet === "Geno`s Collection"}
            ...
            <p>
              <input
                type="radio"
                name="representaive_planet"
                checked={profile.representaive_planet === "NYC Underground ..."}
            ...
            <p>
              <input
                type="radio"
                name="representaive_planet"
                checked={profile.representaive_planet === "Genome Story"}
                value="Genome Story"
                onChange={formik.getFieldProps("picked").onChange}
              />
              <span>
