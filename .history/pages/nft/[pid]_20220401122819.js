    ...
    <div className="mainNft">
      ...
      <div style={{ marginTop: 50, height: "auto" }}>
        ...
        <div className="offerPiceList">
          <Link href="/sell" passHref className="BtnPriceOffer">
            {/* <button >Price Offer</button> */}
          </Link>
          <div className="viewOffers">
            <h3 className="offers">
              Offers
            ...
            {viewLog && (
              <div className="datablock">
                ...
                <p className="headerData">
                  ...
                  >
                    <strong className="mobileYes">minted |</strong> <br/>
                    0.0001
                    <br />
                  ...
                  <span className="mobileYes blue" style={{width: '40%'}}>You / BioArts</span>
                  <span className="blue mobileNo" style={{ padding: 0 }}>
                    You
                  </span>
                </p>
