      ...
      <div style={{ marginTop: 50, height: "auto" }}>
        <div className="commemtListingInfo">
          <div className="viewOffers" style={{marginTop:0}}>
            <h3>Comment <b><Image src="/icon_vwar_02.svg" width={30} height={30} alt="icon" /></b></h3>
          </div>
          <div className="viewOffers">
            <h3>Listing <b><Image src="/icon_vwar_02.svg" width={30} height={30} alt="icon" /></b></h3>
          </div>
          <div className="viewOffers">
            <h3>Info <b><Image src="/icon_vwar_02.svg" width={30} height={30} alt="icon" /></b></h3>
          </div>
        </div>
        <div className="offerPiceList">
          <button className="BtnPriceOffer">Price Offer</button>
          <div className="viewOffers">
            <h3>Offers <b><Image src="/icon_vwar_02.svg" width={30} height={30} alt="icon" /></b></h3>
          </div>
          <div className="viewOffers">
            <h3>Price History <b><Image src="/icon_vwar_02.svg" width={30} height={30} alt="icon" /></b></h3>
          </div>
          <div className="viewOffers">
            <h3>Item log <b><Image src="/icon_vwar_02.svg" width={30} height={30} alt="icon" /></b></h3>
          </div>
        </div>
      </div>
