      ...
      <div style={{ marginTop: 50, height: "auto" }}>
        <div className="commemtListingInfo">
          ...
          <div className="viewOffers">
            <h3>
              ...
              <div className={viewListing>500 ? "datablock" : 'mobileNo'}>
          ...
          <div className="viewOffers">
            <h3>
              ...
              <div className={viewInfo ? "datablock" : 'mobileNo'}>
                <p>
        ...
        <div className="offerPiceList">
          ...
          <div className="viewOffers">
            ...
            <div className={viewOffers > 500 ? "datablock" : "mobileNo"}>
              <p className="headerData bold">
          ...
          <div className="viewOffers">
            ...
            <div className={ "datablock"  + (viewHistory > 500) ? "" : "mobileNo"}>
              <div style={{ height: 50 }}>
                <select>
          ...
          <div className="viewOffers">
            <h3 className="log">
              ...
              <div className={viewLog ? "datablock" : 'mobileNo'}>
                <div style={{ height: 50 }}>
                  <select>
