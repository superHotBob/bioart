...
export default function NFT() {
  ...
  const data = [{},
      {name: '21.01', uv: 0.0001, pv: 2400, amt: 2400},
      {name: '01.06', uv: 0.00001, pv: 2400, amt: 2400},
      {name: '25.08', uv: 0.0001, pv: 2400, amt: 2400},
      {}
  ];
  return (
              ...
              <div className="datablock">
                ...
                {offers.map((i, index) => (
                  <div key={index} className="headerData data">
                    ...
                    <span>
                      <b className="blue" style={{ padding: 0 }}>
                        {i.from}
                      </b>
                      <br />
          ...
          <div className="viewOffers">
            ...
            {viewHistory && (
              <div className="datablock">
                ...
                <LineChart width={myscreen ? 750 : 350} height={200} data={data} margin={{ top: 10, right: 10, bottom: 10, left: 10 }}>
                  <Line  dataKey="uv" stroke="#8884d8"  dot={{ stroke: 'blue', strokeWidth: 5 }}/>
                  <CartesianGrid stroke="#ccc" strokeDasharray="5 5" />
                  <XAxis dataKey="name" />
                  <YAxis axisLine="" domain={['dataMin', 'dataMax']}/>
                  <Tooltip />
                </LineChart>
              </div>
            )}
                ...
                {[1, 2, 3, 4].map((i, index) => (
                  <p key={index} className="headerData">
                    <span className="mobileNo">
                      List <br /><b style={{fontSize: 12}}>7 days ago</b>{" "}
                    </span>
                    <span className="mobileYes" style={{textAlign: 'left'}}>
                      <b><strong>Minted </strong>| 7 days ago</b> <br />
                      <b className="solana blue">0.0001</b>
                    </span>
                    <span className="mobileNo">
                      <b className="solana blue">0.0001</b><br/>
                      <b style={{marginLeft: -45,fontSize: 12}}>$316.46</b>
                    </span>
