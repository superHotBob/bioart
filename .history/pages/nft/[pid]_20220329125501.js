      ...
      <div style={{ marginTop: 50, height: "auto" }}>
        <div className="commemtListingInfo">
          <div className="viewOffers" style={{ marginTop: 0 }}>
            <h3>
              <span className="comment">Comment</span><b>
              <Image
          ...
          <div className="viewOffers">
            <h3>
              <span className="listing">Listing</span><b>
              <Image
                src="/icon_vwar_02.svg"
                width={30}
                height={30}
          ...
          <div className="viewOffers">
            ...
            {viewOffers && (
              <div className="datablock">
                ...
                {offers.map((i, index) => (
                  <p key={index} className="headerData data">
                    <span className="solana blue" style={{textAlign: 'right'}}>{i.price}</span>
          ...
          <div className="viewOffers">
            ...
            {viewHistory && (
              <div className="datablock">
                ...
                <div>All Time Avg.Price <span className="solana blue">0.1</span></div>
              </div>
            )}
          </div>
          <div className="viewOffers">
