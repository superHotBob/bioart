  ...
  return (
    <div className="mainNft">
        ...
        <div className="content">
          ...
          <div className="lastString">
            <div style={{ flexGrow: 4, textAlign: "left" }}>
              Owner by <b className="blue">you</b>
            </div>
            <div className="view">
              <b>
            ...
            {viewComment && (
              <div className="datablock">
                ...
                <div className="one_comment" >
                  ...
                  />
                  <b className="bold">Geny</b>
                  <span>It`s so pretty and I love this picture. thank you.</span>
                  <p>
                    <figure
                      style={{
                        border: 'none',
              ...
              <div className="datablock">
                ...
                {offers.map((i, index) => (
                  <p key={index} className="headerData data">
                    ...
                    <span className="blue" style={{padding: 0}}>{i.from}</span>
                  </p>
                ))}
              </div>
            )}
            ...
            {viewLog && (
              <div className="datablock">
                ...
                <p className="headerData">
                  ...
                  <span className="blue" style={{padding: 0}}>You</span>
                  <span className="blue" style={{padding: 0}}>You</span>
                </p>
              </div>
            )}
      ...
      <style jsx>{`
       ...
       .history {          
          background: #f3f3f3 url("/icon_graph_01.svg") 16px center / 30px no-repeat; 
        }
        .log {          
          background: #f3f3f3 url("/icon_graph_10.svg") 16px center / 30px no-repeat;         
        }
       ...
       .offer_comment {
          background: #f3f3f3 url("/icon_bubblebk.svg") 16px center / 30px no-repeat;          
        }
        h3 span.info:before {
