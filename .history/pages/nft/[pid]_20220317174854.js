  ...
  return (
    <div className="mainNft">
      ...
      <div style={{ marginTop: 50, height: "auto" }}>
        ...
        <section className={styles.sliderNft} style={{marginTop: 100}}>
          <h2 style={{ textAlign: "center" }}>More from this Planet</h2>
          <div className={styles.sliderWraperNft} style={{height: '550px'}}>
            <Slider {...settings}>
              {Array(8).fill(1).map((i,index)=>
              <div className={styles.itemSlider} key={index} style={{height: '45vh'}}>
                <Link href="/nft/one" passHref>
                  ...
                  <h5><span>15.285</span><span>25.000</span></h5>
                  </div>
                </Link>
              </div>)}            
            </Slider>
