    ...
    <div className="mainNft">
        ...
        <div className="content">
          ...
          <div className="lastString">
            ...
            <div className="comment">
              <b>
                 <Image src="/icon_bubblebk.svg" width={30} height={30} alt="icon" />
              </b>
            ...
            <div className="like">
              <b>
                <Image src="/icon_like_on.svg" width={30} height={30} alt="icon" />
              </b>
      ...
      <div style={{ marginTop: 50, height: "auto" }}>
        ...
        <div className="sideMenu">
          <p><Image src='/icon_graph_11.svg' width={20} height={20} alt='icon'/><span>Transfers</span></p>
        </div>
      </div>
