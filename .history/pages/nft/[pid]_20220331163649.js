    ...
    <div className="mainNft">
      ...
      <style jsx>{`
        ...
        .content p {
          ...
          color: #333;
          -webkit-mask-image: ${viewText ? 'null' : `-webkit-gradient(linear, left top, left bottom, 
            from(rgba(0,0,0,1)), to(rgba(0,0,0,0)))`};
        }
        .viewText {
          height: 30px;
          background: url('/icon_vwar_01.svg') center / 10% no-repeat;
        }
        .viewText:hover {         
          background: url('/icon_vwar_01_hv.svg') center / 10% no-repeat;
        }
        .lastString {
