  ...
  return (
    <div className="mainNft">
      ...
      <style jsx>{`
        ...
        .offers {          
          background:  url("/icon_graph_08.svg") 16px 13px / 30px
            no-repeat;
        }
        .history {
          background:  url("/icon_graph_01.svg") 16px center / 30px
            no-repeat;
        }
        .log {
          background:  url("/icon_graph_10.svg") 16px center / 30px
            no-repeat;
        }
        .listing {
          background:  url("/icon_pclbk.svg") 16px center / 30px
            no-repeat;
         
          
        }
        .offer_comment {
          background:  url("/icon_bubblebk.svg") 16px 45% / 30px
            no-repeat;
        }
        .info {
          background:  url("/icon_graph_09.svg") 16px 45% / 30px
            no-repeat;
