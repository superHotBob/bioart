      ...
      <div>
        ...
        <div className="content">
          ...
          <div className="lastString">
            ...
            <div className="view">
              <Image src="/icon_view.svg" width={20} height={20}/> 
            <span>1 {"  "}View</span></div>
            <div className="comment">1 {"  "}Comment</div>
            <div className="like">1 {"  "}Like</div>
          </div>
        </div>
      </div>
                  ...
                  >
                    <Link href="/nft/one" passHref>
                      ...
                      >
                        ...
                        <h5>
                          <b><Image src='/icon_like_on.svg' width={25} height={25} alt='icon'/> </b>
                          <span style={{flexGrow: 8}}>
                            15.285
                          </span>
                          <b><Image src='/icon_bubble.svg' width={25} height={25} alt='icon'/></b>
                          <span>
                            25.000
                          </span>
                        </h5>
