              ...
              <div className="datablock">
                ...
                >
                  <Line
                    dataKey="price"
                    stroke="#00b4e6"
                    dot={{zIndex: 100, stroke: "#00b4e6", strokeWidth: 3 , r: 7 ,strokeFill: '#fff' }}
                  />
                  <CartesianGrid stroke="#c9c9c9" strokeDasharray="5 1 1" />
                  <XAxis dataKey="name" />
                  <YAxis width={70} axisLine={false} domain={["dataMin - 0.00001", "dataMax + 0.00001"]} />
                  <Tooltip wrapperStyle={{textAlign: 'center'}} contentStyle={{borderRadius: 10,with: 20}}/>
                </LineChart>
              </div>
            )}
          </div>
                ...
                {[1, 2, 3, 4].map((i, index) => (
                  <p key={index} className="headerData">
                    <span className="mobileNo">
                      List <br />
                      <b style={{ fontSize: 12 }}>7 days ago</b>{" "}
                    </span>
                    <span className="mobileYes" style={{ textAlign: "left" }}>
                      <b>
                        <strong>Minted </strong>| 7 days ago
                      </b>{" "}
                      <br />
