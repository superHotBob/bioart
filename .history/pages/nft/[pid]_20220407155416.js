  ...
  return (
    <div className="mainNft">
          ...
          <div style={{ height: "auto" }} className={styles.sliderWraperNft}>
            <Slider {...settings}>
              {Array(8)
                .fill(1)
                .map((i, index) => (
                  <div className="itemSliderNft" key={index} style={{width: '96%'}}>
                    <Link href="/nft/one" passHref key={index}>
                      <figure className="imageNft" style={{ borderRadius: 15 }}>
                        <Image
                          layout="fill"
                          alt="image"
                          src={
                    ...
                    <p>
                      ...
                      <strong className="mobileYes">...</strong>
                      <b className="hide__text "> of Life into Information.</b>
                    </p>
      ...
      <style jsx>{`
        ...
        .sale h3 {
          background: #f3f3f3 url(/icon_time.svg) 16px 50% / 30px no-repeat;
          line-height: 30px;
          text-align: left;
          padding-top: 25px;
        }
