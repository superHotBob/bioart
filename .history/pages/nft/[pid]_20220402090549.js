            ...
            {viewListing && (
              <div className="datablock">
                <p
                  ...
                  style={{ paddingLeft: myscreen ? 40 : 0 }}
                >
                  <span>Price</span>
                ...
                {offers.map((i, index) => (
                  <div key={index} className="headerData data">
                    <div style={{textAlign: 'left'}}>
                      ...
                      <b style={{display: 'block',marginTop: 5}}>$316.46</b>
                    </div>
          ...
          <div className="viewOffers">
            ...
            {viewOffers && (
              <div className="datablock">
                ...
                {offers.map((i, index) => (
                  <div key={index} className="headerData data">
                    <div style={{textAlign: 'left', width: myscreen ? '17%' :'34%'}}>
                    <span className="solana blue"> {i.price}</span>
                     
                      <b style={{display: 'block',marginTop: 5}}>$ 314.46</b>
            ...
            {viewLog && (
              <div className="datablock">
                ...
                <p className="headerData bold">
                  ...
                  <span className="mobileYes" style={{width: '40%'}}>From / To</span>
                  <span className="mobileNo">To</span>
                </p>
                {[1,2,3,4].map((i,index)=><p key={index} className="headerData">
                  <span className="mobileNo">
                    List <br />
                    7 days ago
                  </span>
                  <span style={{ width: myscreen ? '13%' : '70%' , textAlign: "start" }} >       
                 
                    <strong style={{width: 'auto',fontSize: 12}} className="mobileYes">Minted | 7 days ago</strong> <br/>
                  ...
                  <span className="mobileYes you__bioarts">You / BioArts</span>
                  <span className="blue mobileNo" style={{ padding: 0 }}>
                    You
                  </span>
                </p>)}
