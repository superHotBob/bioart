              ...
              <div className="datablock">
                ...
                <p className="headerData">
                  ...
                  <span style={{ width: myscreen ? '13%' : '70%' , textAlign: "start" }} >       
                    ...
                    <strong style={{width: 'auto',fontSize: 15}} className="mobileYes">Minted | 7 days ago</strong> <br/>
                  ...
                  <span className="mobileYes" style={{width: '50%', color: 'rgb(0, 180, 230)'}}>You / BioArts</span>
                  <span className="blue mobileNo" style={{ padding: 0 }}>
                    You
                  </span>
                </p>
