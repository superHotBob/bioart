  ...
  return (
    <div className="mainNft">
      ...
      <div style={{ marginTop: 50, height: "auto" }}>
        ...
        <section className={styles.sliderNft} style={{ margin: '150px 0 50px' }}>
          <h2 style={{ textAlign: "center" }}>More from this Planet</h2>
          
            <Slider {...settings}>
              {[1,2,3,4,5,6,7,8]
               
                .map((i, index) => <div key={index} style={{width: 300}}>             
                    <div className="itemSlider"  >
                      <Link href="/nft/one" passHref key={index}>
                        <figure style={{position:'relative',width: '100%',
                        background: 'url(/article-img.png) center / cover no-repeat',
                        height: 200}}
