    ...
    <div className="mainNft">
      ...
      <div style={{ marginTop: 50, height: "auto" }}>
        ...
        <section className={styles.sliderNft}>
          ...
          <div className={styles.sliderWraperNft}>
            <Slider {...settings}>
              <div className={styles.itemSlider}>
                <Link href="/nft/one" passHref>
                  <div
                    ...
                    style={{paddingTop: '50%', backgroundImage: "url(/article-img.png)" }}
                  >
                    ...
                    <p>
                      <b className="iconGraph"><Image src='/icon_graph_01.svg' width={30} height={30} /></b>
                      <span>1.3</span></p>
