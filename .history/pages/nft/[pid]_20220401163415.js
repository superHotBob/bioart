            ...
            {viewLog && (
              <div className="datablock">
                ...
                <p className="headerData">
                  ...
                  <span style={{ width: myscreen ? '13%' : '50%' , textAlign: "start" }} >       
                 
                    <strong style={{width: 'auto'}} className="mobileYes">minted | 7 days ago</strong> <br/>
                    <b style={{ padding: myscreen ? '' : '0'}} className="solana blue">0.0001</b>
                    <br />
