          ...
          <label>
            ...
            <p>
              <input
                ...
                value="Genome NFT"
                checked={representaive_planet === "Genome NFT"}
            ...
            <p>
              <input
                ...
                checked={representaive_planet === "Geno`s_Collection"}
            ...
            <p>
              <input
                type="radio"
                name="representaive_planet"
                checked={representaive_planet === "NYC Underground ..."}
            ...
            <p>
              <input
                type="radio"
                name="representaive_planet"
                checked={representaive_planet === "Genome Story"}
                value="Genome Story"
                onChange={formik.getFieldProps("picked").onChange}
              />
              <span>
