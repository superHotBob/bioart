    ...
    <div className="genosMain">
      ...
      <div className="planets">
        ...
        <div className="planetItems">
          <Image src="/planet-img-01.png" width={650} height={350} alt="item" />

        </div>
        <div className="planetItems">
        <Image src="/planet-img-02.png" width={650}  height={350} alt="item" />
        </div>
      ...
      <style jsx>{`
        * {
        ...
        .planetItems {
          ...
          border-radius: 10px;
          background: linear-gradient(#f3f3f3,#f3f3f3) padding-box, /* 배경에 컬러 설정*/ linear-gradient(150deg, rgba(0,0,255,1) 0%, rgba(152,0,255,1) 41%, rgba(255,0,255,1) 68%, rgba(255,0,0,1)100%) border-box;
          width: 635px;
          height: 535px;
        }
