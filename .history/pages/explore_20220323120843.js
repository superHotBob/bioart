...
export default function Explore() {
  ...
  function setMaxPrice(e) {
    ...
    let Nft = nft
    .sort((a,b) => sort === 'priceLow' ? (a.price < b.price) : (a.price > b.price ) ? 1 : -1)
    .filter(i=> ((minPrice || 0) < i.price && i.price < (e.target.value || 1000)));
    setNewNft([...Nft]);
    console.log(Nft);
  }
  function setMinPrice(e) {
    ...
    let Nft = nft
    .sort((a,b) => sort === 'priceLow' ? (a.price < b.price) : (a.price > b.price ) ? 1 : -1)
    .filter(i=> ((maxPrice || 1000) > i.price && i.price > (e.target.value || 0)));
    setNewNft([...Nft]);
    console.log(Nft);
  }
