      ...
      <div className="items">
        <div className="genomeStore">
            <div className="genomeStore__text"> 
                ...
                <p className="icons">
                    <figure>
                        <Image src='/icon_tele.png' width={30} height={30} alt='icon' />
                    </figure>
                    <figure>
                        <Image src='/icon_insta_b.png' width={30} height={30} alt='icon' />
                    </figure>
                    <figure>
                        <Image src='/icon_facebook.png' width={30} height={30} alt='icon' />
                    </figure>
                    <figure>
                        <Image src='/icon_twitter_b.png' width={30} height={30} alt='icon' />
                    </figure>
                    <a href="/" >bioart.net</a>
