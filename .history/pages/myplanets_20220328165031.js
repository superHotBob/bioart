      ...
      <div className="mainExplore">
        ...
        <div className="items">
          ...
          <div className="filterItem">
             <div className="blockPlus itenSliderImageNft" 
                      />
            {newNft.map((i, index) => (
              <>
                  ...
                  >
                    ...
                    />
                     ...
                     {i.price ? <> <b className="iconGraph">
                       ...
                       <span>{i.price}</span></>:<b className="solidout" >SOLID OUT</b> }
                    </p>
                    <p className="textNft">
      ...
      <style jsx>
        {`
          ...
          .solidout {
            ...
            border-image: linear-gradient(90deg, rgba(0,0,255,1) 0%, rgba(152,0,255,1) 41%, rgba(255,0,255,1) 68%, rgba(255,0,0,1)100%);
            border-image-slice: 1;
            border-radius: 10px;
            padding: 2px;
            background: -webkit-linear-gradient(60deg, rgba(0,0,255,1) 0%, rgba(152,0,255,1) 41%, rgba(255,0,255,1) 68%, rgba(255,0,0,1)100%);
          ...
          .blockPlus {
                      ...
                      border: 1px solid #c7c7c7;
                      border-radius: 15px;
                      background: url('/icon_mrwt.svg') center / 120px no-repeat;
                      }
        `}
      </style>
    </>
