      ...
      <div className="main">
        ...
        <div className="items">
          ...
          <div className="genomeStoreHeader">
            <div className="genomeStoreHeader__text">
              ...
              <div className="icons">
                ...
                <Link href="/" passHref>
                  <b className="blue">bioart.net</b>
                </Link>
              </div>
              <p style={{textAlign: 'left',margin:'10px 30px 0 0'}}>Artistic Transformation of Life into Information.</p>
              <div className="counters">
                ...
                <span>
                  Floor price
                  <figure>
                    <Image src="/icon_graph_01.svg" layout="fill" alt="icon" />
                  </figure>{" "}
                  <b>---</b>
                </span>
                <span>
          ...
          <div className="filterItem">
            ...
            {newNft.map((i, index) => (
              <div key={i.id} className="itemSliderImageNft">
      ...
      <style jsx>
        {`
          ...
          p {           
            margin: 10px 20px;
            text-align: center;
            font: 400 18px/25px "GmarketSansLight";            
          }
          a {
            font-size: 20px;
            color: #00b4e6;
          ...
          @media screen and (max-width: 550px) {
            ...
            p,
            a {
              font: 400 16px/20px "GmarketSansLight";
              display: block;
            }
            .counters span {
              display: block;
              font: 400 14px/27px "GmarketSansMedium";
            }
            .icons figure {
              margin-right: 15px;
            }
