  ...
  return (
    <>
      <div className="mainExplore">
        ...
        <div className="items">
          <div>
            <b className="iconFilterMobile" onClick={() => setViewFilter(!viewFilter)}/>
            <b className="iconMenuMobile" onClick={() => setViewFilter(!viewFilter)}/>
          </div>
      ...
      <style jsx>
        {`
          ...
          @media screen and (max-width: 550px) {
            ...
            .genomeStoreHeader__text h2 {
              font: 800 20px/30px "GmarketSansMedium";
            }
            p,
            a {
              font-size: 16px;
