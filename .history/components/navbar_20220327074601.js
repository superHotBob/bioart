    ...
    <div className={styles.header}>
      ...
      <div className={styles.menu_tab}>
        ...
        <div className={styles.block_likes}>
          ...
          {likes.map((i,index)=>
          <p key={index}>
            <b className={styles.icon_like}><Image src="/article-img.png" width={50} height={50} alt="icon" /></b>
           <span> {i.name} likes this</span>
            <span>{i.date} days ago</span>
            <b className={styles.icon_like}><Image src="/icon_ba.svg" width={50} height={50} alt="icon" /></b>
            <b className={styles.icon_like_last}><Image src="/planet-img-02.png" width={50} height={50} alt="icon" /></b>
          </p>)}
        </div>
      </div>
    </div>
