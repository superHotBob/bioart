...
export default function SideMenu() {
  return (
    <div className="sideMenu">
      ...
      <p>
        <b>
          <Image src="/icon_pclbk.svg" layout="fill" width={25} alt="icon" />
        </b>
        <span>Edit item</span>
      </p>
      <p>
        <b>
          <Image src="/icon_graph_20.svg" layout="fill" width={25} alt="icon" />
        </b>
        <span>Cancel listing</span>
      </p>
      <p>
        <b>
          <Image src="/icon_cls.svg" layout="fill" width={25} alt="icon" />
        </b>
