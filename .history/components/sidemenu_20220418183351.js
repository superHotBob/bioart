...
export default function SideMenu() {
  return (
    <div className="sideMenu">
      ...
      <p>
        <b>
          <Image src="/icon_graph_21.svg" layout="fill"  alt="icon" />
        </b>
        <span>Edit price</span>
      </p>
      <p>
        <b>
          <Image src="/icon_pclbk.svg" layout="fill"  alt="icon" />
        </b>
        <span>Edit item</span>
      </p>
      <p>
        <b>
          <Image src="/icon_graph_20.svg" layout="fill"  alt="icon" />
        </b>
        <span>Cancel listing</span>
      </p>
      <p>
        <b>
          <Image src="/icon_cls.svg" layout="fill"  alt="icon" />
        </b>
      ...
      <style jsx>{`
        ...
        .telegram {
          background-image: url("/icon_tele.png");
        }
        .telegram:hover {
            background-color: #00b4e6;
            color: #fff;
        ...
        .twitter:hover {
            background-color: #00b4e6;
            color: #fff;
            background-image: url("/icon_twitter_w.png");
        }
      `}</style>
    </div>
  );
